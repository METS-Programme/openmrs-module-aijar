...
public class AijarActivator extends org.openmrs.module.BaseModuleActivator {
    ...
    public void started() {
        ...
        try {
            ...
            administrationService.executeSQL("UPDATE concept_name SET concept_name_type = 'FULLY_SPECIFIED' WHERE concept_name_id = 134334 and concept_id=163017", false);
            administrationService.executeSQL("UPDATE concept_name SET locale_preferred = 1 WHERE concept_name_id = 134334 and concept_id=163017", false);
            administrationService.executeSQL(" UPDATE concept_name SET locale_preferred = 0 WHERE concept_name_id = 134333 and concept_id=163017", false);
            administrationService.executeSQL("UPDATE concept_name SET concept_name_type = null WHERE concept_name_id = 134333 and concept_id=163017", false);
